...
import { useAlertEmailDispatch } from "@/hooks/useAlertEmailDispatch";
import { CommandPalette } from "@/components/common/CommandPalette";
import { NotificationCenter } from "@/components/common/NotificationCenter";
import { AIAssistantModal } from "@/components/common/AIAssistantModal";
import { ActionSheet } from "@/components/common/ActionSheet";
import { AuthModal } from "@/components/auth/AuthModal";
import { CustomerPortal } from "@/components/rental/CustomerPortal";
import { RentalOperationsCenter } from "@/components/rental/RentalOperationsCenter";
...
export function Shell({
  ...
  // Watches the shared alert engine and fires (deduplicated) Resend emails
  // for eligible alerts — mounted once here so it evaluates regardless of
  // which route is open, not per-page.
  useAlertEmailDispatch();
